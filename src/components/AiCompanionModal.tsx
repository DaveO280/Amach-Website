...
interface AiCompanionModalProps {
  isOpen: boolean;
  onClose: () => void;
  isFullPage?: boolean; // If true, removes overlay/backdrop for page route usage
}
...
const AiCompanionModal: React.FC<AiCompanionModalProps> = (props) => {
  ...
  // If full page, render without overlay
  if (props.isFullPage) {
    return (
      <div
        ref={modalRef}
      ...
      >
        ...
        <div
          className="p-2 sm:p-4 md:p-6 overflow-auto min-h-[calc(100vh-60px)]"
  ...
  // Regular modal mode (with overlay)
  return (
