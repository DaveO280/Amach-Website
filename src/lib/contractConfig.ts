...
const secureHealthProfileAbi = [
  ...
  // V3_FromV1: Alternative Storj function (different signature)
  {
    inputs: [
      { name: "encryptedData", type: "string" },
      { name: "searchTag", type: "bytes32" },
  ...
  // V3: Public mapping accessors (auto-generated by Solidity)
  {
    inputs: [
      { name: "", type: "address" },
      { name: "", type: "uint256" },
